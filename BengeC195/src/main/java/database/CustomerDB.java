...
/**
 * CustomerDB extends Customer class
 * CustomerDB holds all functions for SQL API calls managing the customers table
 */
public class CustomerDB extends Customer {
    ...
    /**
     * SQL query to retrun all customers in customer table
     * @return customer ObservableList
     * @throws SQLException
     */
    ...
    /**
     * function to add customers to the customers table
     * @param customerName name of customer
     * @param address customer street address
     * @param zip customer postal code
     * @param phone customer mobile number
     * @param divisionID foreign key referncing table that stores location and country data
     * @throws SQLException
     */
    ...
    /**
     * function to edit customers in the customers table
     * @param CID primary key used to reference specific table row
     * @param customerName name of customer
     * @param address customer street address
     * @param zip customer postal code
     * @param phone customer mobile number
    ...
    /**
     * Delete a customer using customers table primary key
     * @param customerID primary key indicating rows in customer table
     * @return Boolean value to reference success of delete
     */
