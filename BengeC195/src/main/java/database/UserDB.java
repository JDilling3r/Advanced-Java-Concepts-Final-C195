...
/**
 * UserDB class contains all functions that interface with SQL API managing users table
 */
public class UserDB {
     ...
     * @param UserIDorName UserID or Username
     * @param password User input password
     * @return Boolean for success of authentication
     * @throws SQLException
     */
