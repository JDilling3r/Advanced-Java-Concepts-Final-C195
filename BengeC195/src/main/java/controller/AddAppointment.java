    ...
    public void handleSaveButton(ActionEvent actionEvent) {
        ...
        if (choice.isPresent() && choice.get() == ButtonType.OK) {
            ...
            if (chosenDate.equals("") || aptType.equals("") || aptTitle.equals("") || aptDescription.equals("")){
                ...
                if (AppointmentDB.addAppointment(aptTitle, aptDescription, location.getValue(), contact.getSelectionModel().getSelectedIndex(), aptType, aptStartTime, Appointments.customer.getCustomerID()))
                {
                    Alert eAlert = new Alert(Alert.AlertType.NONE);
                    ...
                    eAlert.getDialogPane().getButtonTypes().add(ButtonType.OK);
                    eAlert.setContentText("Check time and dates, try again.");
                    eAlert.showAndWait();
                }
            }
        }
