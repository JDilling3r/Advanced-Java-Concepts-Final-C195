...
/**
 * Login controls the authentication page for the application.
 */
public class Login implements Initializable {
    ...
    /**
     * Runs functions to authenticate user after login button is clicked.
    ...
    /**
     * Initializes login view, changes all page data based on user language.
     * @param url
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            languageLabel.setText(lan.getString("language") + ": " + lan.getString(locale.getLanguage().toLowerCase(Locale.ROOT)));
